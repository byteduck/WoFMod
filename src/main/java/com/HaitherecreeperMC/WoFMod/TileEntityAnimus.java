...
public class TileEntityAnimus extends TileEntity implements ISidedInventory
{
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = AnimusRecipies.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
